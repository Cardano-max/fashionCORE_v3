...
def virtual_tryon(clothing_image, person_image):
    ...
    inpaint_mask_image = person_mask
    ...
    task = worker.AsyncTask(args=[
        ...
        [],  # outpaint_selections
        inpaint_input_image, '', inpaint_mask_image,
        ...
        modules.config.default_cfg_tsnr, sampler, scheduler,
        -1, -1, -1, -1, -1, -1,  # overwrite_step, overwrite_switch, overwrite_width, overwrite_height, overwrite_vary_strength, overwrite_upscale_strength
                    ...
                    with gr.TabItem(label='Inpaint or Outpaint') as inpaint_tab:
                        with gr.Row():
                            ...
                            with gr.Column(visible=False) as inpaint_mask_generation_col:
                                ...
                                def generate_mask(image, mask_model, sam_prompt_text, sam_model, sam_quant, box_threshold, text_threshold):
                                    from extras.inpaint_mask import generate_mask_from_image
